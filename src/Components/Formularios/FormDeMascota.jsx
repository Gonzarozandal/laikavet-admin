...
function FormularioMascota({ onAgregarMascota, tutor }) {
    ...
    const handleSubmit = (e) => {//un handler es una funcion que se ejecuta cuando algo sucede
        e.preventDefault();//en este caso, cuando se envia el formulario
    ...
    return (
        <div className="FormularioMascota">
            ...
            {isDisabled && (
                ...
                </p>//la etiqueta p es para parrafo
            )}
