      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-3">
          ...
          <button
            ...
            className="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-6 py-2.5 dark:bg-red-700 dark:hover:bg-red-800 focus:outline-none dark:focus:ring-red-900 shadow-lg hover:shadow-xl transition-all whitespace-nowrap flex items-center gap-2"
          >
            <svg
              className="w-5 h-5"
              fill="none"
